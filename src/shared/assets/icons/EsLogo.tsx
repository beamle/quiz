/* eslint-disable */
export const EsLogo = ({ className }: { className?: string }) => {
  return (
    <svg className={className && className}>
      <g>
        ...
        <path
          d="M152.2,65.8c0-0.7-0.2-1.2-0.7-1.5s-1.3-0.7-2.5-1.1c-1.2-0.4-2.2-0.8-2.9-1.2c-1.9-1.1-2.9-2.5-2.9-4.3
  ...
  c0.8,0,1.5-0.2,2-0.5C152,66.9,152.2,66.4,152.2,65.8z"
        ...
        <path
          d="M124.8,88.6c0-0.7-0.2-1.2-0.7-1.5s-1.3-0.7-2.5-1.1c-1.2-0.4-2.2-0.8-2.9-1.2c-1.9-1.1-2.9-2.5-2.9-4.3
  c0-0.9,0.3-1.8,0.8-2.5c0.5-0.7,1.3-1.3,2.2-1.7c1-0.4,2.1-0.6,3.3-0.6c1.2,0,2.3,0.2,3.3,0.7c1,0.4,1.7,1.1,2.2,1.9
  ...
  c0.8,0,1.5-0.2,2-0.5C124.6,89.7,124.8,89.2,124.8,88.6z"
        ...
        <path
          d={
            'M154.2,89.6H148l-1.2,3.5h-3.7l6.3-17.2h3.3l6.4,17.2h-3.7L154.2,89.6z M149,86.7h4.3l-2.1-6.4L149,86.7z'
          }
        />
        <path d={'M172.4,78.8h-5.2v14.3h-3.5V78.8h-5.1v-2.9h13.9V78.8z'} />
        <path d={'M178.3,93.1h-3.5V75.9h3.5V93.1z'} />
        <path
          d="M190.6,88.6c0-0.7-0.2-1.2-0.7-1.5s-1.3-0.7-2.5-1.1s-2.2-0.8-2.9-1.2c-1.9-1.1-2.9-2.5-2.9-4.3c0-0.9,0.3-1.8,0.8-2.5
  ...
  C190.4,89.7,190.6,89.2,190.6,88.6z"
        ...
        <path
          d={
            'M224.4,86.2l-1.8,2v4.9h-3.5V75.9h3.5v7.8l1.5-2.1l4.3-5.7h4.3l-6,7.6l6.2,9.6h-4.2L224.4,86.2z'
          }
        />
        <path
          d={
            'M244.1,89.6H238l-1.2,3.5h-3.7l6.3-17.2h3.3l6.4,17.2h-3.7L244.1,89.6z M238.9,86.7h4.3l-2.1-6.4L238.9,86.7z'
          }
        />
      </g>
      <g>
